%% Linea por Linea, en focus_distance = inf
...
pml_z_size = 15;                % [grid points]

% set total number of grid pointsta not including the PML
Nx = 500 - 2 * pml_x_size;      % [grid points]
Ny = 250 - 2 * pml_y_size;      % [grid points]
...
if RUN_SIMULATION
    ...
    save us_bmode_scan_lines scan_lines;
